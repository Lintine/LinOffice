...
class Capybara(QMainWindow):
    ...
    def create_tool_bar(self):
        ...
        undo_action = QAction('undo', 'undo', self)
        undo_action.triggered.connect(self.editor.undo)
        tool_bar.addAction(undo_action)

        redo_action = QAction('redo', 'redo', self)
        ...
        cut_action = QAction('cut', 'cut', self)
        cut_action.triggered.connect(self.editor.cut)
        tool_bar.addAction(cut_action)

        copy_action = QAction('copy', 'copy', self)
        copy_action.triggered.connect(self.editor.copy)
        tool_bar.addAction(copy_action)
        
        paste_action = QAction('paste', 'paste', self)
